      ...
      <main className="flex flex-col md:flex-row gap-5 md:justify-center items-start md:items-center md:py-[8rem] md:px-[3rem] p-[2rem]">
        ...
        >
          <motion.h1
            ...
            variants={{
              hidden: { opacity: 0, y: 20 },
              show: { opacity: 1, y: 0, transition: { duration: 2.0 } },
            }}
          >
            MathMorph is where AI meets Learning Science: Powering an
            all-Inclusive Smarter Education
          </motion.h1>
          <motion.p
          ...
          >
            MathMorph as a cutting-edge platform at the intersection of
            artificial intelligence and educational research.
          </motion.p>

          <motion.div
            className="btn flex flex-row items-start gap-3"
            variants={{
              hidden: { opacity: 0, y: 20 },
              show: { opacity: 1, y: 0, transition: { duration: 2.0 } },
            }}
